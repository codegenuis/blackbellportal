...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="position-ref full-height">
            ...
            <h2 style="margin-bottom: 30px;font-weight:600;color:#203D79;">Add New Dealer</h2>
            <div class="shadow p-3 mb-5 bg-white rounded">
            <form action="{{ action('AdminController@addDealers') }}" method="post">
@if ($errors->any())
...
<div class="form-group">
<label>Tsm</label>
<input type="text"  class="form-control" name="Tsm" /> 
</div>
<div class="form-group">
<label>Tsm code</label>
<input type="text"  class="form-control" name="Tsmcode" /> 
</div>
<div class="form-group">
<label>Tsm Phone number</label>
<input type="text"  class="form-control" name="Tsmphone" /> 
</div>
<div class="form-group">
<label>Tsm Email</label>
<input type="text"  class="form-control" name="Tsmemail" /> 
</div>
<div class="form-group">
<label>Cpe</label>
<input type="text"  class="form-control" name="Cpe" /> 
</div>
<div class="form-group">
<label>Cpe Code</label>
<input type="text"  class="form-control" name="Cpecode" /> 
</div>
<div class="form-group">
<label>Cpe Phone number</label>
<input type="text"  class="form-control" name="Cpephone" /> 
</div>
<div class="form-group">
<label>Cpe Email</label>
<input type="text"  class="form-control" name="Cpeemail" /> 
</div>
<div class="form-group">
